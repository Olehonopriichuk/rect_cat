(function() {
    ...
    function updateConditions() {
        ...
        if (windowWidth <= 576) {
            conditions = [
                { start: 0.05, end: 0.15, hoverClass: "icon-hover" },
                { start: 0.20, end: 0.30, hoverClass: "icon-hover2" },
                { start: 0.40, end: 0.50, hoverClass: "icon-hover3" },
                { start: 0.60, end: 0.70, hoverClass: "icon-hover4" },
                { start: 0.80, end: 0.90, hoverClass: "icon-hover5" }
            ];
        } else if (windowWidth >= 576) {
            conditions = [
                { start: 0.04, end: 0.12, hoverClass: "icon-hover" },
                { start: 0.21, end: 0.28, hoverClass: "icon-hover2" },
                { start: 0.38, end: 0.44, hoverClass: "icon-hover3" },
                { start: 0.54, end: 0.62, hoverClass: "icon-hover4" },
                { start: 0.73, end: 0.80, hoverClass: "icon-hover5" }
            ];
        } else if (windowWidth >= 768) {
            conditions = [
                { start: 0, end: 0.12, hoverClass: "icon-hover" },
                { start: 0.13, end: 0.34, hoverClass: "icon-hover2" },
                { start: 0.35, end: 0.50, hoverClass: "icon-hover3" },
                { start: 0.51, end: 0.68, hoverClass: "icon-hover4" },
                { start: 0.69, end: 0.90, hoverClass: "icon-hover5" }
            ];
        }
    }
